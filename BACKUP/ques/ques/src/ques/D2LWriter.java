...
public class D2LWriter {
    ...
    //-------------------------------------------//
    public D2LWriter(String xmlFile) {
        try {
            out = new PrintWriter(
    ...
    public void writeD2LFile(Document document) {
        try {
    ...
    public void writeNode(Node node) {
            ...
            case Node.ELEMENT_NODE: {
                if (node.getNodeName().equals("questions")); // skip
                    ...
                    if (i >= 0) {
                        ...
                        out.print(transBB8Attr(attrCur.getNodeValue()));
                        // Print DELIM
                    ...
                    out.print("Title: ");  // just put "return;" to kill off this node
                } else if (node.getNodeName().equals("desc"))
                    out.print("" + questionNumber++ + ") " + titleText + " [HTML]"); // out.print("<i>");
        ...
        if (type == Node.ELEMENT_NODE) {
            if (node.getNodeName().equals("questions"))
                ...
                out.print("[/HTML]"); //out.println("#^"); // out.print("</i>");
