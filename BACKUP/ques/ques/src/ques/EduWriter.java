...
public class EduWriter {
    ...
    //-------------------------------------------//
    public EduWriter(String xmlFile) {
        try {
            out = new PrintWriter(
    ...
    public void writeNode(Node node) {
        ...
        switch (type) {
            ...
            case Node.ELEMENT_NODE: {
                if (node.getNodeName().equals("questions")); // skip
                    ...
                    if (i >= 0) {
                        ...
                        out.print(attrCur.getNodeValue() + ":");
                    }
                    ...
                    out.print("<b>");
                } else if (node.getNodeName().equals("desc")); // out.print("<i>");
            ...
            case Node.TEXT_NODE: {
                ...
                if (insidePRE) {
                    s = ExpandTabs.expand(node.getNodeValue(), Main.TABSTOP, true);
                } else {
        ...
        if (type == Node.ELEMENT_NODE) {
            if (node.getNodeName().equals("questions")); // skip
                ...
                insidePRE = false;
            } else if (node.getNodeName().equals("answers")); else if (node.getNodeName().equals("ans")) {
                out.println("#^");
            } else if (node.getNodeName().equals("ansp")) {
                out.println("#^");
            } else if (node.getNodeName().equals("pre")) {
                out.print("</pre>");
                insidePRE = false;
            } else if (node.getNodeName().equals("solution")); else if (node.getNodeName().equals("image")); else {
